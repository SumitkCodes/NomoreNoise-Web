...
DROP POLICY "Anyone can view complaints" ON public.complaints;
DROP POLICY "Anyone can create complaints" ON public.complaints;
DROP POLICY "Anyone can update complaint status" ON public.complaints;
